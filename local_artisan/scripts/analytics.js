...
function drawCharts({ totalRevenue, productCount, productRevenue, revenueByDate }) {
  new Chart(document.getElementById("revenueDonut"), {
    ...
    data: {
      labels: ["Revenue"],
      datasets: [{ data: [totalRevenue], backgroundColor: ["#7d6be5"], borderWidth: 1 }]
    },
    options: { plugins: { title: { display: true, text: "Total Revenue", font: { size: 18 } } } }
  });
  ...
  new Chart(document.getElementById("performanceLine"), {
    ...
    data: {
      ...
      datasets: [{ label: "Revenue", data: Object.values(revenueByDate), fill: false, borderColor: "#ff6f61", tension: 0.2 }]
    },
    options: { plugins: { title: { display: true, text: "Store Performance", font: { size: 18 } } } }
  });
  ...
  new Chart(document.getElementById("topProductsBar"), {
    ...
    data: {
      ...
      datasets: [{ label: "Quantity Sold", data: Object.values(productCount), backgroundColor: "#69c0ff" }]
    },
    options: {
      plugins: { title: { display: true, text: "Top Selling Products", font: { size: 18 } } },
      indexAxis: 'x'
    }
  });
  
}
module.exports = { groupData, drawCharts };
